        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TapChargeId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TapCustomerId = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductStocks_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductStocks_AspNetUsers_UpdatedById",
                        column: x => x.UpdatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "0191a4b6-c4fc-752e-9d95-40b30fa7a9b6", 0, "0191a4b6-c4fc-752e-9d95-40b42a925b8e", "admin@GUP.Ecommerce.com", true, "Survey Basket", false, "Admin", false, null, "ADMIN@GUP.ECOMMERCE.COM", "ADMIN@GUP.ECOMMERCE.COM", "AQAAAAIAAYagAAAAEKNBpPV7qI3TPxuNFJth5cCA3sNdI7bs07Sh+Wu9vUrr+13Ls03V1e8EFNMZEYo8Mg==", null, false, "55BF92C9EF0249CDA210D85D1A851BC9", false, "admin@GUP.Ecommerce.com" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductStocks_CreatedById",
                table: "ProductStocks",
                column: "CreatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductStocks_UpdatedById",
                table: "ProductStocks",
                column: "UpdatedById");
        }
